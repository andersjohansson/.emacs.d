  ...
  (unless (member theme '(use-package user)) ;enable theme calls itself with user theme.
    ...
    (with-eval-after-load 'org-faces
      ...
      (when (eq theme 'modus-operandi)
        ...
        (defface aj/org-todo `((t :inherit org-modern-todo :foreground ,(modus-themes-color 'red))) "Face for todo org-state" :group 'org-faces)
        (defface aj/org-waiting `((t :inherit 'aj/org-todo :foreground ,(modus-themes-color 'yellow))) "Face for waiting org-state" :group 'org-faces)
