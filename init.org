...
#+begin_src emacs-lisp
(use-package request) ;; TODO, fixa som dep för aj-custom-commands
(use-package xah-replace-pairs)
(use-package aj-custom-commands
  :straight nil
  :demand t ;; TODO fixa autoloads
...
(use-package define-word-thesaurus
  :straight (:host gitlab :repo "andersjohansson/define-word-thesaurus")
...
(use-package spotify
  ...
  :config
  (setq spotify-mode-line-playing-text (all-the-icons-faicon "play-circle" :v-adjust 0.01)
