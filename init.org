...
#+BEGIN_SRC emacs-lisp
(declare-function TeX-run-TeX "tex-buf") ; can’t get why this is needed
(with-eval-after-load 'tex-buf
...
(use-package helm
  ...
  (defvar aj/helm-source-header-fg nil)
  (defvar aj/helm-source-header-bg nil)
  (defvar aj/helm-source-header-box nil)
  ;; (defvar aj/helm-selection-fg nil)
  (defvar aj/helm-selection-bg nil)
  (defun aj/helm-set-faces ()
    (setq aj/helm-source-header-fg (face-attribute 'helm-source-header :foreground)
          aj/helm-source-header-bg (face-attribute 'helm-source-header :background)
          aj/helm-source-header-box (face-attribute 'helm-source-header :box)
          ;; aj/helm-selection-fg (face-attribute 'helm-selection :foreground)
          aj/helm-selection-bg (face-attribute 'helm-selection :background)))

  (add-hook 'aj/face-definitions-hook 'aj/helm-set-faces)
  ...
  (defun helm-toggle-header-line ()
    (if (> (length helm-sources) 1)
        (set-face-attribute 'helm-source-header
                            nil
                            :foreground aj/helm-source-header-fg
                            :background aj/helm-source-header-bg
                            :box aj/helm-source-header-box
                            :height 1.0)
      (set-face-attribute 'helm-source-header
                          nil
                          :foreground aj/helm-selection-bg
                          :background aj/helm-selection-bg
                          :box nil
                          :height 0.1)))
...
(use-package aj-custom-commands
  ...
  (with-eval-after-load
      "dired" (bind-key "<s-return>" 'sudo-edit-current-file dired-mode-map)))
#+end_src
...
(use-package helm-flyspell
  :ensure t
  :commands help-flyspell-correct
...
(defun aj/org-flyspell-skip-links (fun)
  (if (memq (face-at-point) '(org-link org-date))
      nil
    (funcall fun)))
...
(use-package pdf-tools
  ...
  (add-hook 'pdf-view-mode-hook #'pdf-view-auto-slice-minor-mode t)
  ...
  (bind-keys
   ...
   ("q" . aj/pdf-hl-and-copy)
   ;;("w" . aj/pdf-hl-and-copy)
   ("w" . aj/pdf-ul)
   ("e" . aj/pdf-ol)
   ("r" . aj/pdf-sq)
   ("t" . aj/pdf-hl-note)
   ("Q" . (lambda () (interactive) (aj/pdf-hl t)))
   ("W" . (lambda () (interactive) (aj/pdf-ul t)))
   ("E" . (lambda () (interactive) (aj/pdf-ol t)))
   ("R" . (lambda () (interactive) (aj/pdf-sq t)))
