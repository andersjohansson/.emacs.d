...
(defface aj/missing-eol-period '((t :inherit trailing-whitespace :extend t)) "Face for marking missing periods")
...
(defvar aj/missing-eol-period-fl-keywords
  ...
  ;; without periods etc.
  '(("^[[:alnum:]]" "\\b[[:word:]]+[^].?!:]$" nil nil (0 'aj/missing-eol-period prepend))))
