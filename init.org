...
(defhydra aj/cycle-buffers (:color red)
  ...
  ("q" nil "Quit"))
#+end_src
*** Next/previous-buffer with ~<C-tab>~ and ~<C-S-tab>~ (like switching tabs in firefox ..)
#+begin_src emacs-lisp
(bind-keys
 ("<C-tab>" . previous-buffer)
 ("<C-iso-lefttab>" . next-buffer)) ;; really C-S-tab ...
#+end_src
...
*** Toggle font size
Sometimes I feel the need for a generally bigger font in all emacs frames. Especially when switching between my 13 inch 1920*1080-screen and my 24 inch 1920*1080-screen (systemwide screenwise fractional scaling is still not an option on linux).
#+begin_src emacs-lisp
...
(use-package modus-operandi-theme
  :custom (modus-operandi-theme-fringes 'subtle)
  (modus-operandi-theme-subtle-diffs t)
  (modus-operandi-theme-org-blocks 'greyscale)
  (modus-operandi-theme-heading-block t)
