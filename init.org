...
(use-package org
  ...
  (setq org-directory "~/org"
        ...
        org-modules '(org-habit org-inlinetask org-mu4e org-id org-bullets org-zotxt org-pdfview)
...
(use-package define-word
  ;; :ensure t
  :load-path "~/kodat/elisp/define-word/"
...
#+begin_src emacs-lisp
(use-package spotify
  :load-path "~/kodat/elisp/spotify.el/"
  :defer t
  :custom
  (spotify-transport 'connect)
  (spotify-api-locale "sv_SE")
  (spotify-api-country "SE")
  (spotify-mode-line-playing-text (all-the-icons-faicon "play-circle" :v-adjust 0.01))
  (spotify-mode-line-paused-text (all-the-icons-faicon "pause-circle" :v-adjust 0.01))
  (spotify-mode-line-stopped-text (all-the-icons-faicon "stop-circle" :v-adjust 0.01))
...
(use-package pdf-loader
  ;; :load-path "~/kodat/elisp/pdf-tools/"
