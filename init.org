...
(use-package pdf-oc-quote
  ...
  ;; :load-path ("~/kodat/elisp/pdf-oc-quote/" "~/kodat/elisp/oc-emacs/")
  :commands (pdf-oc-quote-mode pdf-oc-quote-cleanup-mode pdf-oc-quote-activate)
  :custom
  (pdf-oc-quote-fill-column 999999)
  (pdf-oc-quote-ligatures
   '(("ﬁ" . "fi")
     ("ﬃ" . "ffi")
     ("ﬀ" . "ff")
     ("ﬂ" . "fl")
     ...
     ("‘‘" . "“")
     ("’’" . "”")))
  (pdf-oc-quote-cite-functions
   (list
    #'pdf-oc-quote-cite-from-bibtex
    (pdf-oc-quote-make-cite-function
     #'aj/helm-bibtex-cite))))
#+end_src
