...
(use-package mu4e
  ...
  :custom ((mu4e-view-use-gnus nil) ;; still problems with it for me
...
*** View shortened addresses (mer saker här!)
...
(use-package mu4e-thread-folding
  ...
  (with-eval-after-load 'modus-operandi-theme
    ...
    (set-face-attribute 'mu4e-thread-folding-child-face nil :background 'unspecified :inherit 'modus-themes-nuanced-blue)
    ))
