...
List of prefix strings or regex."
  ...
  (set-face-attribute 'org-annotate-face nil
                      :weight 'unspecified :underline nil :italic t :inherit '(default))
  ...
  (defun aj/org-annotate-edit (_linkstring)
...
#+begin_src emacs-lisp
(straight-use-package 'request) ;; TODO, dependency for zotxt. Fix!
(straight-use-package 'deferred)
(straight-use-package 'request-deferred)

(use-package zotxt
  :straight (zotxt-emacs :host gitlab :repo "egh/zotxt-emacs"
						 :fork (:host gitlab :repo "andersjohansson/zotxt-emacs"))
...
(with-eval-after-load 'org-re-reveal
  (setq
   ...
   org-re-reveal-extra-css "../assets/ajwhite.css"
...
#+begin_src emacs-lisp
(defface aj/org-special-tags-face '((t . (:inherit org-tag :box t)))
  "Face for special tags"
:group 'aj)

(defface aj/org-select-tags-face
  '((t . (:inherit (hydra-face-teal org-tag aj/org-special-tags-face))))
  "Face for select tags"
  :group 'aj)
(defface aj/org-exclude-tags-face
  '((t . (:inherit (hydra-face-red org-tag aj/org-special-tags-face))))
  "Face for exclude tags"
  :group 'aj)
(defface aj/org-ignoreheading-tags-face
  '((t . (:inherit (aj/org-special-tags-face))))
...
See also the amazing real-time overlay solution posted here:
https://lists.gnu.org/archive/html/emacs-orgmode/2018-11/msg00015.html

#+BEGIN_SRC emacs-lisp
(use-package org-outline-numbering
  :straight (:host gitlab :repo "andersjohansson/org-outline-numbering")
