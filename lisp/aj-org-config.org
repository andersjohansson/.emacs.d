...
have `org-warning' face."
  ...
  ;; have `org-warning' face."
  ;;     (let* ((line (aref (pcase heading
  ;; 		                 (`nil org-indent--text-line-prefixes)y
  ;; 		                 (`inlinetask org-indent--inlinetask-line-prefixes)
  ;; 		                 (_ org-indent--heading-line-prefixes))
  ;; 		               level))
  ;; 	       (wrap
  ...
  ;; 	              nil 'face 'org-indent)
  ;;               (pcase heading
  ;;                 (`nil (let ((wl (+ (length line) indentation)))
  ;;                         (aj/org-indent-make-space wl ?\s wl)))
  ;;                 (`inlinetask (aj/org-indent-make-space level ?\s level))
  ;;                 (_ (aref aj/org-indent--heading-wrap-prefixes level))))))
  ;;       ;; Add properties down to the next line to indent empty lines.
  ;;       (add-text-properties (line-beginning-position) (line-beginning-position 2)
  ;; 			               `(line-prefix ,line wrap-prefix ,wrap)))
...
stopped."
	       ...
	       (while (and (<= (point) end) (not (eobp)))
	         (cond
              ...
              ((org-in-block-p '("quote"))
               ;; (org-element-lineage (org-element-at-point) '(quote-block) t)
               ;; (cl-intersection (face-at-point nil t)
               ;;                  '(aj/org-quote-beg-end-face org-quote))
               (org-indent-set-line-properties
                (+ 1 level)
                (current-indentation)))
	          ;; Regular line.
  ...
  ;; (el-patch-defun org-indent-add-properties (beg end &optional delay)
  ;;     "Add indentation properties between BEG and END.
